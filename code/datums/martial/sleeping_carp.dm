...
/datum/martial_art/the_sleeping_carp/proc/strongPunch(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(prob(10))
		...
		D.visible_message(span_warning("[D] staggers as the blow strikes them with inhuman force!"), span_userdanger("I am struck with incredible precision by [A]!"))
...
/datum/martial_art/the_sleeping_carp/proc/launchKick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	D.visible_message(span_warning("[A] kicks [D] square in the chest, sending them flying!"), \
					span_userdanger("I am kicked square in the chest by [A], sending you flying!"), span_hear("I hear a sickening sound of flesh hitting flesh!"), COMBAT_MESSAGE_RANGE, A)
...
/datum/martial_art/the_sleeping_carp/proc/dropKick(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if((D.mobility_flags & MOBILITY_STAND))
		...
		D.visible_message(span_warning("[A] kicks [D] in the head, sending them face first into the floor!"), \
					span_userdanger("I am kicked in the head by [A], sending you crashing to the floor!"), span_hear("I hear a sickening sound of flesh hitting flesh!"), COMBAT_MESSAGE_RANGE, A)
	else
...
/datum/martial_art/the_sleeping_carp/harm_act(mob/living/carbon/human/A, mob/living/carbon/human/D)
	...
	if(CHECK_MOBILITY(D, MOBILITY_STAND) && damage >= stunthreshold)
		to_chat(D, span_danger("I stumble and fall!"))
...
/datum/martial_art/the_sleeping_carp/on_projectile_hit(mob/living/carbon/human/A, obj/item/projectile/P, def_zone)
	...
	if(!isturf(A.loc)) //NO MOTHERFLIPPIN MECHS!
		return BULLET_ACT_HIT
	A.visible_message(span_danger("[A] dodges the projectile cleanly, they're immune to ranged weapons!"), span_userdanger("I dodge out of the way of the projectile!"))
...
/mob/living/carbon/human/proc/sleeping_carp_help()
	...
	to_chat(usr, span_notice("I can dodge all projectiles. However, you are not invincible, and sustained damage will take it's toll on your stamina before your health."))
