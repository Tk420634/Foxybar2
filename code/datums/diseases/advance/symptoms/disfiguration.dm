...
/datum/symptom/disfiguration/Activate(datum/disease/advance/A)
	...
	switch(A.stage)
		if(5)
			...
			M.visible_message(span_warning("[M]'s face appears to cave in!"), span_notice("I feel your face crumple and cave in!"))
		else
			M.visible_message(span_warning("[M]'s face begins to contort..."), span_notice("My face feels wet and malleable..."))
