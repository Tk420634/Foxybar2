...
/obj/machinery/atmospherics/components/trinary/filter/examine(mob/user)
	. = ..()
	. += span_notice("I can hold <b>Ctrl</b> and click on it to toggle it on and off.")
	. += span_notice("I can hold <b>Alt</b> and click on it to maximize its flow rate.")
...
/obj/machinery/atmospherics/components/trinary/filter/AltClick(mob/user)
	...
	if(user.canUseTopic(src, BE_CLOSE, FALSE,))
		...
		to_chat(user,span_notice("I maximize the flow rate on the [src]."))
