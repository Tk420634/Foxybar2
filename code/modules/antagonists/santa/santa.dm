...
/datum/antagonist/santa/greet()
	. = ..()
	to_chat(owner, span_boldannounce("I am Santa! Your objective is to bring joy to the people on this station. You can conjure more presents using a spell, and there are several presents in your bag."))
