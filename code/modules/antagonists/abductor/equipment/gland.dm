...
/obj/item/organ/heart/gland/proc/mind_control(command, mob/living/user)
	if(!ownerCheck() || !mind_control_uses || active_mind_control)
		return FALSE
	mind_control_uses--
	to_chat(owner, span_userdanger("I suddenly feel an irresistible compulsion to follow an order..."))
...
/obj/item/organ/heart/gland/proc/clear_mind_control()
	if(!ownerCheck() || !active_mind_control)
		return FALSE
	to_chat(owner, span_userdanger("I feel the compulsion fade, and you <i>completely forget</i> about your previous orders."))
