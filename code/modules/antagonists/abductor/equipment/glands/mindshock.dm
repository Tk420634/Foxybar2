...
/obj/item/organ/heart/gland/mindshock/activate()
	...
	for(var/mob/living/carbon/H in orange(4,T))
		...
		switch(pick(1,3))
			if(1)
				to_chat(H, span_userdanger("I hear a loud buzz in your head, silencing your thoughts!"))
				H.Stun(50)
			if(2)
...
/obj/item/organ/heart/gland/mindshock/mind_control(command, mob/living/user)
	...
	for(var/mob/M in oview(7, owner))
		...
		broadcasted_mobs += H
		to_chat(H, span_userdanger("I suddenly feel an irresistible compulsion to follow an order..."))
...
/obj/item/organ/heart/gland/mindshock/clear_mind_control()
	...
	for(var/M in broadcasted_mobs)
		var/mob/living/carbon/human/H = M
		to_chat(H, span_userdanger("I feel the compulsion fade, and you <i>completely forget</i> about your previous orders."))
