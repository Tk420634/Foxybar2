...
/obj/item/organ/heart/gland/quantum/proc/quantum_swap()
	...
	to_chat(owner, span_warning("I suddenly find yourself somewhere else!"))
	to_chat(entangled_mob, span_warning("I suddenly find yourself somewhere else!"))
...
/obj/item/organ/heart/gland/quantum/mind_control(command, mob/living/user)
	if(..())
		if(entangled_mob && ishuman(entangled_mob) && (entangled_mob.stat < DEAD))
			to_chat(entangled_mob, span_userdanger("I suddenly feel an irresistible compulsion to follow an order..."))
...
/obj/item/organ/heart/gland/quantum/clear_mind_control()
	if(active_mind_control)
		to_chat(entangled_mob, span_userdanger("I feel the compulsion fade, and you completely forget about your previous orders."))
