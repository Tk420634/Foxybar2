...
/datum/antagonist/fugitive_hunter/greet()
	...
	to_chat(owner, span_boldannounce("I am not an antagonist in that you may kill whomever you please, but you can do anything to ensure the capture of the fugitives, even if that means going through the station."))
