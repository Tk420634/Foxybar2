...
/datum/antagonist/blood_contract/proc/start_the_hunt()
	...
	for(var/mob/living/carbon/human/P in GLOB.player_list)
		if(P == H || HAS_TRAIT(P, TRAIT_NO_MIDROUND_ANTAG))
			continue
		to_chat(P, span_userdanger("I have an overwhelming desire to kill [H]. [H.p_theyve(TRUE)] been marked red! Whoever [H.p_they()] [H.p_were()], friend or foe, go kill [H.p_them()]!"))
