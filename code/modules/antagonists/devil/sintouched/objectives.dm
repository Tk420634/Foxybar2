...
/datum/objective/sintouched/greed
	explanation_text = "I want MORE, more money, more wealth, more riches.  Go get it, but don't hurt people for it."

/datum/objective/sintouched/sloth
	explanation_text = "I just get tired randomly.  Go take a nap at a time that would inconvenience other people."
...
/datum/objective/sintouched/pride
	explanation_text = "I am the BEST thing on the station.  Make sure everyone knows it."
