...
/datum/nanite_program/necrotic/active_effect()
	...
	if(prob(1))
		to_chat(host_mob, span_warning("I feel a mild ache from somewhere inside you."))
...
/datum/nanite_program/toxic/active_effect()
	...
	if(prob(1))
		to_chat(host_mob, span_warning("I feel a bit sick."))
...
/datum/nanite_program/suffocating/active_effect()
	...
	if(prob(1))
		to_chat(host_mob, span_warning("I feel short of breath."))
...
/datum/nanite_program/skin_decay/active_effect()
	...
	if(prob(5)) //itching
		...
		span_warning("My [bodypart.name] itches. [can_scratch ? " You scratch it." : ""]"))
...
/datum/nanite_program/nerve_decay/active_effect()
	if(prob(5))
		to_chat(host_mob, span_warning("I feel unbalanced!"))
		host_mob.confused += 10
	else if(prob(4))
		to_chat(host_mob, span_warning("I can't feel your hands!"))
		host_mob.drop_all_held_items()
	else if(prob(4))
		to_chat(host_mob, span_warning("I can't feel your legs!"))
