...
/datum/surgery_step/dissection/preop(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(user, target, span_notice("I start dissecting [target]."),
...
/datum/surgery_step/dissection/success(mob/user, mob/living/target, target_zone, obj/item/tool, datum/surgery/surgery)
	...
	display_results(user, target, span_notice("I dissect [target], and add your [points_earned] point\s worth of discoveries to the research database!"),
...
/datum/surgery_step/dissection/failure(mob/user, mob/living/carbon/target, target_zone, obj/item/tool, datum/surgery/surgery)
	display_results(user, target, span_notice("I dissect [target], but do not find anything particularly interesting."),
