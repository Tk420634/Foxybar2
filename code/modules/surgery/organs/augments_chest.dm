...
/obj/item/organ/cyberimp/chest/nutriment/emp_act(severity)
	...
	to_chat(owner, span_warning("I feel like your insides are burning."))
...
/obj/item/organ/cyberimp/chest/reviver/on_life()
	...
	reviving = TRUE
	to_chat(owner, span_notice("I feel a faint buzzing as your reviver implant starts patching your wounds..."))
...
/obj/item/organ/cyberimp/chest/reviver/emp_act(severity)
	...
	if(ishuman(owner))
		...
		if(H.stat != DEAD && prob(severity/2) && H.can_heartattack())
			...
			to_chat(H, span_userdanger("I feel a horrible agony in your chest!"))
...
/obj/item/organ/cyberimp/chest/reviver/proc/undo_heart_attack()
	...
	if(H.stat == CONSCIOUS || H.stat == SOFT_CRIT)
		to_chat(H, span_notice("I feel your heart beating again!"))
...
/obj/item/organ/cyberimp/chest/thrusters/proc/toggle(silent = FALSE)
	if(!on)
		...
		if(allow_thrust(0.01))
			...
			if(!silent)
				to_chat(owner, span_notice("I turn your thrusters set on."))
	else
		ion_trail.stop()
		if(!QDELETED(owner))
			...
			if(!silent)
				to_chat(owner, span_notice("I turn your thrusters set off."))
		on = FALSE
	update_icon()
