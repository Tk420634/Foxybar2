...
/mob/living/simple_animal/hostile/eldritch/raw_prophet/proc/link_mob(mob/living/mob_linked)
	...
	to_chat(mob_linked, span_notice("I feel something new enter your sphere of mind, you hear whispers of people far away, screeches of horror and a humming of welcome to [src]'s Mansus Link."))
...
/mob/living/simple_animal/hostile/eldritch/raw_prophet/proc/unlink_mob(mob/living/mob_linked)
	...
	qdel(action)
	to_chat(mob_linked, span_notice("My mind shatters as the [src]'s Mansus Link leaves your mind."))
