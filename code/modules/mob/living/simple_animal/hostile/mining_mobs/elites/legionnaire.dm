...
/datum/action/innate/elite_attack/legionnaire_charge
	...
	chosen_message = span_boldwarning("I will attempt to grab your opponent and throw them.")
	chosen_attack_num = LEGIONNAIRE_CHARGE

/datum/action/innate/elite_attack/head_detach
	name = "Release Head"
	button_icon_state = "head_detach"
	chosen_message = span_boldwarning("I will now detach your head or kill it if it is already released.")
	chosen_attack_num = HEAD_DETACH

/datum/action/innate/elite_attack/bonfire_teleport
	name = "Bonfire Teleport"
	button_icon_state = "bonfire_teleport"
	chosen_message = span_boldwarning("I will leave a bonfire.  Second use will let you swap positions with it indefintiely.  Using this move on the same tile as your active bonfire removes it.")
