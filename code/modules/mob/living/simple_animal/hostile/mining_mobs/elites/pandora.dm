...
/datum/action/innate/elite_attack/pandora_teleport
	...
	chosen_message = span_boldwarning("I will now teleport to your target.")
	chosen_attack_num = PANDORA_TELEPORT

/datum/action/innate/elite_attack/aoe_squares
	name = "AOE Blast"
	button_icon_state = "aoe_squares"
	chosen_message = span_boldwarning("My attacks will spawn an AOE blast at your targette location.")
