...
/datum/species/human/spec_life(mob/living/carbon/human/H)
	...
	if (H.radiation>2500 && prob(10) && !(HAS_TRAIT(H,TRAIT_FEV)||HAS_TRAIT(H,TRAIT_RADIMMUNE)))
		to_chat(H, span_danger("My skin begins to peel and fall off from radiation! Meanwhile you feel your vocal cords burn and twist your voice into a horrible rasping growl!"))
