	...
	switch(P.type)
		if(/obj/item/projectile/energy/floramut)
			if(prob(15))
				...
				H.visible_message(span_warning("[H] writhes in pain as [H.p_their()] vacuoles boil."), span_userdanger("I writhe in pain as your vacuoles boil!"), span_italic("I hear the crunching of leaves."))
				if(prob(80))
