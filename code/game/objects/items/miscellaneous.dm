...
/obj/item/choice_beacon/proc/spawn_option(atom/choice,mob/living/M)
	...
	if(ishuman(M))
		...
		if(istype(H.ears, /obj/item/radio/headset))
			msg = "I hear something crackle in your ears for a moment before a voice speaks.  \"Please stand by for a message from Central Command.  Message as follows: <span class='bold'>Item request received. Your package is inbound, please stand back from the landing site.</span> Message ends.\""
	to_chat(M, msg)
