...
/obj/structure/chair/e_chair/proc/shock()
	...
	if(has_buckled_mobs())
		for(var/m in buckled_mobs)
			...
			to_chat(buckled_mob, span_userdanger("I feel a deep shock course through your body!"))
			addtimer(CALLBACK(buckled_mob, TYPE_PROC_REF(/mob/living,electrocute_act), 85, src, 1), 1)
	visible_message(span_danger("The electric chair went off!"), span_italic("I hear a deep sharp shock!"))
