...
/datum/reagent/growthchem/on_mob_life(mob/living/M)
	...
	if(size < RESIZE_MACRO)
		...
		M.visible_message(span_danger("[pick("[M] grows!", "[M] expands in size!", "[M] pushes outwards in stature!")]"), span_danger("[pick("I feel your body fighting for space and growing!", "The world contracts inwards in every direction!", "I feel your muscles expand, and your surroundings shrink!")]"))
	..()
	. = 1
...
/datum/reagent/shrinkchem/on_mob_life(mob/living/M)
	...
	if(size > RESIZE_MICRO)
		M.update_size(size - 0.025)
		M.visible_message(span_danger("[pick("[M] shrinks down!", "[M] dwindles in size!", "[M] compresses down!")]"), span_danger("[pick("I feel your body compressing in size!", "The world pushes outwards in every direction!", "I feel your muscles contract, and your surroundings grow!")]"))
	..()
	. = 1
