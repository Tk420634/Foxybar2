...
/datum/action/innate/elite_attack/lavamoat
	...
	chosen_message = span_boldwarning("I will attempt to create a lava moat around you.")
...
/datum/action/innate/elite_attack/lavaaround
	...
	chosen_message = span_boldwarning("I will now create lava rivers at your cardinal directions.")
...
/datum/action/innate/elite_attack/firespew
	...
	chosen_message = span_boldwarning("I will now spew fire at your target.")
...
/datum/action/innate/elite_attack/firemoat
	...
	chosen_message = span_boldwarning("I will now spew fire at all cardinal directions.")
